...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Category News</h1>  <small class="page-info text-secondary-d2">
              ...
              <div  class="card-body">
                <table id="" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td class="text-grey">
                          <p> {{$n->title}}</p>
                          <img width="100px"  src="{{'storage/images/'.$n->image}}"/>
                      </td>
                      <td class="text-grey">
                          {!! $n->summary !!}
                      </td>
                      ...
                      <td class="text-grey">
                          @if($n->highlight == config('constants.highlight.no'))
                                  {{'No'}}
                          @else
                                  {{'Yes'}}
                          @endif
                      ...
                      <td>
                        <a href="{{ route('news.edit',['id'=> $n->id ]) }}" ><i class="fa fa-edit text-blue-m1 text-120"></i></a>
                      </td>
                    <td>
                        <a href="{{ route('news.delete',['id'=> $n->id ]) }}" onclick="return confirm('Are you sure ?');" ><i class="fas fa-trash-alt text-danger-m1"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
