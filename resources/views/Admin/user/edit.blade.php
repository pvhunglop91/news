                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control password" type="password" name="passwordAgain"
                               placeholder="Enter password again" disabled=""/>
                            ...
                            @foreach($role as $r)
                                <div class="form-group form-check ml-3">
                                    <input class="form-check-input"
                                           {{ ($user->roles->contains('id', $r->id)) ? 'checked' : '' }} value="{{ $r->id }}"
                                           name="role_id[]" type="checkbox" id="{{ $r->name }}">
                                    <label for="{{ $r->name }}" class="form-check-label">{{ $r->name }}</label>
                                </div>
                            @endforeach
                        </div>
                    </div>
