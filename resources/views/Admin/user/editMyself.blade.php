...
@section('content')
    ...
    <div class="container">
        <div class="card card-primary">
            ...
            <form action={{route('user.update.myself', [Auth::user()->id])}}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label> Email</label>
                        <input type="email"  class="form-control" value="{{$user->email}}" name="email" placeholder="Enter email" disabled/>
                        @if($errors->has('email'))
