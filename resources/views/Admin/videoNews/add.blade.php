        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href={{route('video-news.create')}} class="nav-link active">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Add</p>
                        </a>
                    </li>
...
@section('content')
    ...
    <div class="container">
        <div class="card card-primary">
            ...
            <form action="{{ route('video-news.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Path</label><span class="text-danger"> *</span>
